  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-blush/30 via-cream to-mauve/20">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        ...
        <h1 className="font-heading text-5xl md:text-7xl text-charcoal leading-tight mb-6">
          Your Journey to
          <span className="block text-mauve">Motherhood,</span>
          Celebrated
        </h1>
        <p className="font-body text-charcoal/60 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
