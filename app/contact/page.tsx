  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-blush/20 via-cream to-mauve/10 py-20 px-4 text-center">
        ...
        <h1 className="font-heading text-5xl text-charcoal mb-4">Book Your Session</h1>
        <p className="font-body text-charcoal/60 max-w-xl mx-auto">
          Ready to capture your most precious moments? Fill in the form below or WhatsApp Jeanie directly.
        </p>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-5">
            ...
            <li className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="mailto:jeanie@lumarion.co" className="font-body text-charcoal/60 text-sm hover:text-mauve transition-colors">
                  jeanie@lumarion.co
                </a>
              </div>
            </li>
          ...
          <div className="mt-8">
            <a
              href="https://wa.me/601160979138?text=Hi%20Jeanie!%20I%27d%20love%20to%20book%20a%20photoshoot%20with%20Sweet%20Arrival."
              target="_blank"
